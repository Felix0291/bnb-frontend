...
// //             setError("Boendet är inte tillgängligt för dessa datum.");
// //             return;
// //         }
...
// //             <div className='fixed top-20 left-0 w-full p-8'>
// //                 <div className='max-w-4xl mx-auto text-center'>
// //                     <p className='text-lg mb-4'>Detta boende är inte tillgängligt för bokning.</p>
// //                     <button
// //                         onClick={() => navigate("/")}
// //                         className="px-6 py-2 bg-indigo-600 text-white rounded"
// //                         >
...
// // {isDateSelected && property.availability && (
// //                         <button
// //                             onClick={handleBooking}
